...
public class NoticeFileTest {
	...
	public void noticeFileTest() throws Exception {
		String markdown = generateActlistPluginNoticeMarkdown();
	...
	private String generateActlistPluginNoticeMarkdown() {
		return NoticeFileGenerator.newInstance("Actlist Plugin", "silentsoft.org")
